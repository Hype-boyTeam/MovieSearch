...
public class MovieService
{
    ...
    public async Task GetMoviesById(IList<Guid> movieId)
    {
        // var movies = await _db.Infos
        //     .ToListAsync();
        // TODO: return MovieInfoDto
        throw new NotImplementedException();
    }
    ...
    /// </returns>
    public async Task<IList<Guid>> SearchMovie(string text, int limit = 10)
    {
